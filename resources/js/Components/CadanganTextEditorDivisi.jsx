...
const TextEditorDivisi = ({ value, onChange, onImagesChange }) => {
    ...
    }, [selectedImage]); // Tambahkan selectedImage sebagai dependensi agar selalu update

    // ✅ Upload gambar
    const uploadImageCallback = async (file) => {
        const timestamp = Date.now();
        const extension = file.name.split('.').pop();
        const customFileName = `divisi-${timestamp}.${extension}`;
        ...
        // Alih-alih mengirim formData, kirim nama file custom ke onImagesChange
        ...
        try {
          ...
          const response = await fetch("/upload-image-content-divisi", {
            method: "POST",
            body: formData,
    ...
    const handleRemoveImage = async () => {
        ...
        if (blockKeyToDelete) {
            ...
            try {
                ...
                await fetch(`/delete-image-content-divisi`, {
                    method: "DELETE",
                    headers: {
...
export default TextEditorDivisi;
