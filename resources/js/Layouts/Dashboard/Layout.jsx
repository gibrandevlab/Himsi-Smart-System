...
export default function Layout({ children, role }) {
    ...
    const handleClickOutside = (e) => {
        if (e.target.id == "overlay-sidebar") {
    ...
    return (
        <>
                ...
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center justify-start rtl:justify-end">
                            ...
                            <Link
                                href="/"
                                className="ms-2 md:me-24 sm:block hidden"
                            >
                                <img
                                    src="/storage/HimsiLogo/himcore.png"
                                    className="h-10 me-3"
                                    alt="Logo"
                                />
                            </Link>
                    ...
                    <ul className="space-y-2 font-medium">
                        <li>
                            ...
                            >
                                ...
                                <span className="ms-3 font-inter-medium">
                                    Dashboard
                                </span>
                            </Link>
                        </li>
                        ...
                        <li>
                            ...
                            >
                                ...
                                <svg
                                    className={`w-3 h-3 transition-transform ${
                                        divisiDrop ? "rotate-180" : "rotate-0"
                                    }`}
                                    aria-hidden="true"
                                    xmlns="http://www.w3.org/2000/svg"
                                    fill="none"
                            ...
                            <ul
                                className={`py-2 space-y-2 transition-all duration-200 font-inter-medium ${
                                    divisiDrop ? "block" : "hidden"
                                }`}
                            >
                                <li>
                                    <Link
                                        href="/dashboard/manage-divisi/"
                                        className="flex items-center w-full p-2 text-gray-900 transition duration-200 rounded-lg pl-11 group hover:bg-gray-100 opacity-80 hover:opacity-100"
                                    >
                                        List Divisi
                                    </Link>
                                ...
                                <li>
                                    <Link
                                        href="/dashboard/manage-divisi/create"
                                        className="flex items-center w-full p-2 text-gray-900 transition duration-200 rounded-lg pl-11 group hover:bg-gray-100 opacity-80 hover:opacity-100"
                                    >
                                        Tambah Divisi
                                    </Link>
            ...
            <div className="p-4 sm:ml-64 pt-20 pb-10">{children}</div>
        </>
    );
}