...
const Pertemuan = () => {
    return (
        <Layout>
            <div className="flex flex-col border-b border-gray-200 pb-6 md:pb-8 pt-12 md:pt-16 bg-white p-4 md:p-6 rounded-xl mt-2 bg-gradient-to-r from-[#ae00ff] to-[#9500ff]">
                ...
                <p className="text-[12px] md:text-sm font-inter-regular text-white md:w-[70%] opacity-95">
                    List pertemuan yang akan datang dan bisa kamu ikuti. beberapa
