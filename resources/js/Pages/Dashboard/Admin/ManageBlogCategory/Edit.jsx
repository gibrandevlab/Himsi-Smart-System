...
const ManageBlogCategoryEdit = ({data_blog_category}) => {
    
     // SETUP FORM
    const { data, setData } = useForm({
        nama: data_blog_category.nama,
        icon: data_blog_category.icon,
    });
    ...
    function submit(e) {
        e.preventDefault();
        router.post(`/dashboard/manage-blog-category/${data_blog_category.slug}`, {
            _method: 'put',
            data_form: data,
        });
    }
...
export default ManageBlogCategoryEdit;
